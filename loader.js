...
(function() {
  ...
  if (!raw) {
    document.write('<scr' + 'ipt type="text/javascript" src="ol3/build/ol.js"></scr' + 'ipt>');
  } else {
    window.CLOSURE_NO_DEPS = true; // we've got our own deps file
    document.write('<scr' + 'ipt type="text/javascript" src="ol3/closure-library/closure/goog/base.js"></scr' + 'ipt>');
    document.write('<scr' + 'ipt type="text/javascript" src="ol3/build/ol-deps.js"></scr' + 'ipt>');
